...
All four test projects can be opened and run in <a href="http://testwisely.com" target="_blank">TestWise2</a>, you can easily to try out and compare yourself.
...
If you need to run Test against Firefox, then Selenium2 is the only choice. For IE, Watir is more mature and more stable IMO.
